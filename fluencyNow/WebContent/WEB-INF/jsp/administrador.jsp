...
<title>Exemplo de cabecalho responsivo</title>
...
<button type="button" class="btn btn-danger">Excluir aluno</button>
<button type="button" class="btn btn-warning">Editar Aluno</button>
<button type="button" class="btn btn-success">Novo aluno +</button>
    </div>
<div class="col-sm-3">
<div class="input-group">
<input class="pesquisa" type="search" placeholder="Pesquisar" aria-label="Search" style="border-right: none;">
<div class="input-group-append">
<div class="input-text" style="background-color: #FFF"><i class="fas fa-search"></i></div>
</div>
</div>
</div>
</div>
    ...
    <div class="col-md-6">
      <form class="formulario-contato">
        ...
        <div class="form-group">
          ...
          <div>
            <a href="https://wa.me/5511945390855" class="btn btn-primary btn-cadastrar"> Cadastrar Aula + <div class="botaocadastrar">
              </div>
              <a>
                <strong>
                <p>Plano</p>
...
<option value="3">18:00</option>
                  ...
                  <div class="btn btn-primary btn-cadastraraula"> Salvar <div
...
<button type="button" class="btn btn-warning">Editar Plano</button>
<button type="button" class="btn btn-success">Novo plano +</button>
    </div>
<div class="col-sm-6">
<div class="input-group">
<input class="pesquisa" type="search" placeholder="Pesquisar" aria-label="Search" style="border-right: none;">
