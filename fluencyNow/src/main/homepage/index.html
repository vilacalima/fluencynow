    ...
    <nav class="navbar navbar-expand-md navbar-light bg-light">
      <div class="container-fluid">
        ...
        <a class="navbar-brand" href="#">
          <img src="assets/images/Logo.png" alt="Logo" style="height: 150px;">
        </a>
        ...
        <form class="formulario-contato">
          ...
          <div class="form-group">
            ...
            <a href="https://wa.me/5511945390855" class="btn btn-primary btn-enviar">Enviar WhatsApp <img class="whats"
                src="assets/images/whatsapp1.png" /></a>
          </div>
          <!-- <a href="https://wa.me/5511945390855" class="btn btn-primary btn-enviar" >Enviar WhatsApp <img class="whats" src="assets/images/whatsapp1.png" > -->
        </form>
      ...
      <div class="carousel-inner no-padding my-5">
        <div class="carousel-item active">
          <div class="col-xs-4 col-sm-4 col-md-4">
            <img src="assets/images/Ingles.png" class="card-img-top" alt="Imagem do Card 1">
        ...
        <div class="carousel-item">
          <div class="col-xs-4 col-sm-4 col-md-4">
            <img src="assets/images/Espanhol.png" class="card-img-top" alt="Imagem do Card 1">
